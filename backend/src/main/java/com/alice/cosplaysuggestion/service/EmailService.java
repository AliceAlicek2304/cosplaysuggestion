...
public class EmailService {
    ...
    public void sendVerificationEmail(String to, String token) {
        ...
        try {
            ...
            helper.setTo(to);
            helper.setSubject("Xác thực tài khoản Cosplay Suggestion");
            ...
            String htmlContent = """
                <html>
                <body>
                    <h2>Chào mừng bạn đến với Cosplay Suggestion!</h2>
    ...
    public void sendWelcomeEmail(String to, String fullName) {
        try {
            ...
            helper.setFrom(fromEmail);
            helper.setTo(to);
            helper.setSubject("Chào mừng bạn đến với Cosplay Suggestion!");
    ...
    public void sendPasswordResetEmail(String to, String fullName, String resetCode) {
        ...
        try {
            ...
            helper.setFrom(fromEmail);
            helper.setTo(to);
            helper.setSubject("Đặt lại mật khẩu - Cosplay Suggestion");
                ...
                <body>
                    <div class="container">
                        ...
                        <div class="content">
                            ...
                            <p>Bạn đã yêu cầu đặt lại mật khẩu cho tài khoản Cosplay Suggestion của mình.</p>
